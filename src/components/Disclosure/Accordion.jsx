  ...
  return (
    <div className={`block w-full h-auto mb-6 ${className}`}>
      ...
      <button
        ...
        className="w-full py-5 px-6 flex leading-none items-center justify-between bg-body-200 rounded-default transition duration-default hover:bg-body-300 focus-visible:a11y-primary"
        type="button"
