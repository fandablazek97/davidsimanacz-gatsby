  ...
  return (
    <AppLayout>
      ...
      <div className="space-y-10 mb-32">
        <div className="ui-wrapper rounded-xl bg-body-200" data-wrapper="lg">
          <div className="w-full rounded-xl bg-blue-500 dark py-8 mb-4 flex flex-col items-center justify-center">
            <h3 className="text-white ui-heading" data-heading="md">
              ui-wrapper lg
            </h3>
        ...
        <div className="ui-wrapper rounded-xl bg-body-200">
        ...
        <div className="ui-wrapper rounded-xl bg-body-200" data-wrapper="sm">
